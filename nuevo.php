...
//--------------------------Profesionales--------------------------
$pdf->Cell(0, 30, '', 0, 1, 'C', 0, '', 0); //Espacio en blanco
//Línea 5
$pdf->SetFont('times', '', 11);
$pdf->writeHTMLCell(27, 0, $mi, 85, 'PRESIDENTE:', 0, 1, 0, true, 'L', true);
$pdf->writeHTMLCell(187-$mi-$md, 0, $mi+27, 85, $presidente, 'B', 1, 0, true, 'L', true);
//Línea 6
$pdf->writeHTMLCell(28, 0, $mi, 91, 'SECRETARIO: ', 0, 1, 0, true, 'L', true);
$pdf->writeHTMLCell(186-$mi-$md, 0, $mi+28, 91, $secretario, 'B', 1, 0, true, 'L', true);
//Línea 7
$pdf->writeHTMLCell(20, 0, $mi, 97, 'VOCAL I: ', 0, 1, 0, true, 'L', true);
$pdf->writeHTMLCell(194-$mi-$md, 0, $mi+20, 97, $vocal1, 'B', 1, 0, true, 'L', true);
//Línea 8
$pdf->writeHTMLCell(21, 0, $mi, 103, 'VOCAL II: ', 0, 1, 0, true, 'L', true);
$pdf->writeHTMLCell(193-$mi-$md, 0, $mi+21, 103, $vocal2, 'B', 1, 0, true, 'L', true);
//Línea 9
$pdf->writeHTMLCell(22, 0, $mi, 109, 'VOCAL III: ', 0, 1, 0, true, 'L', true);
$pdf->writeHTMLCell(192-$mi-$md, 0, $mi+22, 109, $vocal3, 'B', 1, 0, true, 'L', true);
